...
- [x] Deep MLP and GRU extensions preserve validation-only tuning and untouched test evaluation.
- [x] Universal ML/DL criterion and strict statistical-gate policy are reported explicitly.
